<?php
	...
	$english = array(
		...
		'tinymce_extended:remove' => "Add/Remove editor",
		...
		'tinymce_extended:defaults:menu1' => "bold,italic,underline,separator,strikethrough,bullist,numlist,undo,redo,link,unlink,image,blockquote,code",
